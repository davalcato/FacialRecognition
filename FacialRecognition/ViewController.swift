...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate  {
    ...
    func showLandMarks(_ face:VNFaceObservation) {
        ...
        drawLandmark(landmark: face.landmarks?.outerLips, context: context, rect: faceRect, closePath: true)
        drawLandmark(landmark: face.landmarks?.innerLips, context: context, rect: faceRect, closePath: true)
        drawLandmark(landmark: face.landmarks?.leftEye, context: context, rect: faceRect, closePath: true)
        drawLandmark(landmark: face.landmarks?.rightEye, context: context, rect: faceRect, closePath: true)
        drawLandmark(landmark: face.landmarks?.leftPupil, context: context, rect: faceRect, closePath: true)
        drawLandmark(landmark: face.landmarks?.rightPupil, context: context, rect: faceRect, closePath: true)
